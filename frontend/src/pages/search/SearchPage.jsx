        ...
        <div class="container">
            ...
            <div class="mx-auto" style={{width:"100%", maxWidth:"600px"}}>
                <div class="input-group">
                    <select value={department} onChange={(e)=>setDepartment(e.target.value)} class="form-select border-primary w-25" style={{height:"60px"}}>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100" src={teamImg1} style={{objectFit:"cover"}} />
                        </div>
                ...
                <div class="col-lg-6 team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100" src={teamImg2} style={{objectFit:"cover"}} />
                        </div>
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Doctor Name</h3>
                ...
                <div class="col-lg-6 team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        <div class="col-12 col-sm-5 h-100">
                            <img class="img-fluid h-100" src={teamImg3} style={{objectFit:"cover"}} />
                        </div>
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Doctor Name</h3>
