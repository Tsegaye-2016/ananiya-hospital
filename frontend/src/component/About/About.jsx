    ...
    <div className="row gx-5 align-items-center">
      ...
      <div className="col-lg-7">
        ...
        <p>
          ...
          ipsum et, tempor voluptua sit consetetur sit. Aliquyam diam amet diam et eos
          sadipscing labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem
          sit. Sanctus clita duo justo et tempor consetetur takimata eirmod, dolores
        ...
        <div className="row g-3 pt-3">
          ...
          <div className="col-sm-3 col-6">
            <div className="bg-light text-center rounded-circle py-4">
              ...
              <h6 className="mb-0">
                Inpatient
                <small className="d-block text-primary">Service</small>
              </h6>
            </div>
          </div>
        </div>
