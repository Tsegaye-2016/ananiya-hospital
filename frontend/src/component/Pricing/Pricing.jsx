...
import price1Img from '../../assets/img/price-1.jpg'
import price2Img from '../../assets/img/price-2.jpg'
import price3Img from '../../assets/img/price-3.jpg'
import price4Img from '../../assets/img/price-4.jpg'
function Pricing() {
  return (
            ...
            <div className="owl-carousel price-carousel position-relative" style={{ padding: "0 45px 45px 45px" }}>
                <div className="bg-light rounded text-center">
                    <div className="position-relative">
                        <img className="img-fluid rounded-top" src={price1Img} alt="Price 1"/>
                ...
                <div className="bg-light rounded text-center">
                    <div className="position-relative">
                        <img className="img-fluid rounded-top" src={price2Img} alt="Price 2" />
                        <div className="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style={{background: "rgba(29, 42, 77, .8)"}}>
                ...
                <div className="bg-light rounded text-center">
                    <div className="position-relative">
                        <img className="img-fluid rounded-top" src={price3Img} alt="Price 3" />
                        <div className="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style={{background: "rgba(29, 42, 77, .8)"}}>
                ...
                <div className="bg-light rounded text-center">
                    <div className="position-relative">
                        <img className="img-fluid rounded-top" src={price4Img} alt="Price 4" />
                        <div className="position-absolute w-100 h-100 top-50 start-50 translate-middle rounded-top d-flex flex-column align-items-center justify-content-center" style={{background: "rgba(29, 42, 77, .8)"}}>
