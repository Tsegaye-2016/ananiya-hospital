                        ...
                        <form>
                            <div className="row g-3">
                                <div className="col-12 col-sm-6">
                                    <select value={department} onChange={(e)=>setDepartment(e.target.value)} className="form-select bg-light border-0" style={{height: "55px"}}>
                                ...
                                <div className="col-12 col-sm-6">
                                    <select value={Doctor} onChange={(e)=>setDoctor(e.target.value)} className="form-select bg-light border-0" style={{height: "55px"}}>
